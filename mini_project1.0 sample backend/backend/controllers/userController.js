...
const { promiese: fsPromises } = require('fs');
...
const register = asyncHandler(async (req, res) => {
    ...
    if(!password.match(passwordRegex)) {
        throw new BadRequestError('Password must contain at least one uppercase letter, one lowercase letter, one number, and one special character, and be at least 8 characters longs')
    }
...
module.exports = { register, login, sendResetPassword, resetPassword }
